...
console.log(stringCut(firstSentence));
console.log(stringCut(secondSentence));
console.log(stringCut(thirdSentence));
...
console.log(registerConvert("c&c rED aLERT 3"));

// Задание 3

function stringAnalys(str) {
  result = {};
  result.allSymbols = str.length;
...
console.log(stringAnalys("Давайте жить дружно!"));
